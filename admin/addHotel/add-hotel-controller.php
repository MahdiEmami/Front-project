...
include("../../config.php");
$sql="INSERT INTO hotel(hname,hprov,hcity,hdesc,hprice,hstar,hpic) VALUES('{$hotel_name}','{$hotel_province}','{$hotel_city}','{$hotel_desc}','{$hotel_price}','{$hotel_star}','{$hotel_pic}')";
$db->query($sql);
$db->close();
